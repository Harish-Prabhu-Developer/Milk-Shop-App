      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ zIndex: 4000 }} className="mb-4">
          <DropDownPicker
            ...
            setValue={val => updateFilter('routeName', val)}
            setItems={() => {}}
            listMode='SCROLLVIEW'
        ...
        <View style={{ zIndex: 3000 }} className="mb-4">
          <DropDownPicker
            ...
            setValue={val => updateFilter('routeType', val)}
            setItems={() => {}}
            listMode='SCROLLVIEW'
        ...
        <View style={{ zIndex: 2000 }} className="mb-4">
          <DropDownPicker
            ...
            setValue={val => updateFilter('branchName', val)}
            setItems={() => {}}
        ...
        <View style={{ zIndex: 1000 }} className="mb-6">
          <DropDownPicker
            ...
            items={paidOptions}
            setOpen={setPaidOpen}
            setValue={val => updateFilter('paidStatus', val)}
            setItems={() => {}}
